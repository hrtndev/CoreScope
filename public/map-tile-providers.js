...
(function () {
  ...
  var _getCartoApiKey = function() { return (_cfg && _cfg.providers && _cfg.providers.carto && _cfg.providers.carto.apiKey) || ''; };
  // Carto's keyed basemaps API is served from a single unsharded host (no {s} subdomain).
  var _getCartoUrl = function(path) {
    var key = _getCartoApiKey();
    return key
      ? 'https://basemaps.cartocdn.com/' + path + '?key=' + encodeURIComponent(key)
      : _getCartoBase() + '/' + path;
  };
  ...
  var BASE_STYLES = {
    'carto-dark': { provider: 'carto', label: 'Carto Dark', url: function() { return _getCartoUrl('dark_all/{z}/{x}/{y}{r}.png'); }, invertFilter: null, type: 'dark', attribution: '© OpenStreetMap © CartoDB', maxZoom: 19 },
    'carto-light': { provider: 'carto', label: 'Carto Positron', url: function() { return _getCartoUrl('light_all/{z}/{x}/{y}{r}.png'); }, invertFilter: null, type: 'light', attribution: '© OpenStreetMap © CartoDB', maxZoom: 19 },
    'carto-voyager': { provider: 'carto', label: 'Carto Voyager', url: function() { return _getCartoUrl('rastertiles/voyager/{z}/{x}/{y}{r}.png'); }, invertFilter: null, type: 'light', attribution: '© OpenStreetMap © CartoDB', maxZoom: 19 },
    'carto-voyager-dark': { provider: 'carto', label: 'Carto Voyager', url: function() { return _getCartoUrl('rastertiles/voyager/{z}/{x}/{y}{r}.png'); }, invertFilter: INVERT_CSS, type: 'dark', attribution: '© OpenStreetMap © CartoDB', maxZoom: 19 },
    'positron-dark': { provider: 'carto', label: 'Carto Positron', url: function() { return _getCartoUrl('light_all/{z}/{x}/{y}{r}.png'); }, invertFilter: INVERT_CSS, type: 'dark', attribution: '© OpenStreetMap © CartoDB', maxZoom: 19 },
